...
public class IceChest implements StoreFood{
    ...
    //    would have to define how it would StoreFood
    public void keepFresh(){
//        if the user wants to add something to ice chest, does the item need ice?
//        If item needs ice, can set hasIce to true. Then add more items.
//        if not set hasIce to false and continue to add items.
