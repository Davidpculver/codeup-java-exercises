...
//    INSTRUCTOR EXAMPLE
//    // Use SuppressWarnings Annotation to remove reduntant warning seen by using the valueOf static method.
//    @SuppressWarnings("all")
//    // ===EDIT FOR EXCEPTION ERRORS===
//    public int getInt(String prompt){
//        // Please enter a number.
//        // save this input as String userInput = scanner.nextLine();
